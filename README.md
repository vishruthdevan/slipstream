...
- User personalisation - Since users can already navigate to their favourite drivers and teams conveniently, we feel this feature doesn't add a lot of value.
